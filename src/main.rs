...
fn main() {
    ...
    index.add_document("0", "Cyclone Pinney Seroja (pictured) makes landfall in Indonesia and East Timor, killing at least 113 people and displacing thousands of others.");
